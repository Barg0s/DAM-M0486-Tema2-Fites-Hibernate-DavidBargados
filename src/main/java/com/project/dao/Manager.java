...
public class Manager {
    ...
    public static Habilitat addHabilitat(String nom, String descripcio, Integer cost) {
        ...
        try {
            ...
            tx.commit();
            System.out.println("[OK] Habilitat creada:" + nom + "( cost: " + cost + ")");
    ...
    */
    ...
    public static Personatge addPersonatge(String nom, Double atac, Double defensa, 
        ...
        try {
            ...
            tx.commit();
            System.out.println("[OK] Personatge creat: " + nom + " (" + faccio.getNom() + ")");
            if (habilitats.length > 0){
    ...
    public static void printPersonatges() {
        ...
        try {
            ...
            for (Personatge p : personatges) {
                System.out.println(p.getNom() + "( " + p.getFaccio().getNom() +")" + "\n Atac: " + p.getAtac() + " | Defensa: " + p.getDefensa() + "\n Habilitats: " + p.getHabilitats());
            }
        } catch (Exception e) {
            System.err.println("Error llegint faccions: " + e.getMessage());
        } finally {
